...
- [#358](https://github.com/genomic-medicine-sweden/nallo/pull/358) - Fixed single-sample VCFs containing sites from all samples (as ./. calls)
- [#358](https://github.com/genomic-medicine-sweden/nallo/pull/358) - Fixed filter_vep present in docs but not in pipeline
