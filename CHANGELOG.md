...
- [#1156](https://github.com/genomic-medicine-sweden/nallo/pull/1156) - Added sorting of bam files by name in `ALIGN_ASSEMBLIES` and `HIPHASE` to fix unstable snapshots
