...
- [#1101](https://github.com/genomic-medicine-sweden/nallo/pull/1101) - Replaced local `rank_variants` subworkflow with shared genomic-medicine-sweden `vcf_annotate_score_genmod`
