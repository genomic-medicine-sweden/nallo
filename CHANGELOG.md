...
- [#512](https://github.com/genomic-medicine-sweden/nallo/pull/512) - Changed `single_sample` to `sample` output directory for CNV calling missed in [#502](https://github.com/genomic-medicine-sweden/nallo/pull/502)
