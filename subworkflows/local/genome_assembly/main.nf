...
workflow GENOME_ASSEMBLY {
    ...
    if (!trio_binning) {
        ...
        // Creates the input for children with both parents (with paternal and maternal yak)
        ...
        // Creates the input for children with a single parent (without paternal or maternal yak)
