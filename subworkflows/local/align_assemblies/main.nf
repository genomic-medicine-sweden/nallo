...
workflow ALIGN_ASSEMBLIES {
    ...
    emit:
    unfiltered_bam = SAMTOOLS_MERGE_UNFILTERED.out.bam // channel: [ val(meta), path(bam) ]
    unfiltered_bai = SAMTOOLS_MERGE_UNFILTERED.out.index // channel: [ val(meta), path(bai) ]
    bam            = SAMTOOLS_MERGE.out.bam // channel: [ val(meta), path(bam) ]
    bai            = SAMTOOLS_MERGE.out.index // channel: [ val(meta), path
