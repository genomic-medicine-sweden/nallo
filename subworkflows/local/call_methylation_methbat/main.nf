...
workflow CALL_METHYLATION_METHBAT {
    ...
    pbcpg_bed_hap1        = PBCPGTOOLS_ALIGNEDBAMTOCPGSCORES.out.hap1_bed           // channel: [ val(meta), path(hap1.bed.gz) ]
    pbcpg_index_hap1      = PBCPGTOOLS_ALIGNEDBAMTOCPGSCORES.out.hap1_bed_index     // channel: [ val(meta), path(hap1.bed.gz.tbi) ]
    pbcpg_bed_hap2        = PBCPGTOOLS_ALIGNEDBAMTOCPGSCORES.out.hap2_bed           // channel: [ val(meta), path(hap2.bed.gz) ]
    pbcpg_index_hap2      = PBCPGTOOLS_ALIGNEDBAMTOCPGSCORES.out.hap2_bed_index     // channel: [ val(meta), path(hap2.bed.gz.tbi) ]
}
