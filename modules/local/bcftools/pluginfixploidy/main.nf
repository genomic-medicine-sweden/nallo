process BCFTOOLS_PLUGINFIXPLOIDY {
    ...
    container "${workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ? 'https://community-cr-prod.seqera.io/docker/registry/v2/blobs/sha256/47/474a5ea8dc03366b04df884d89aeacc4f8e6d1ad92266888e7a8e7958d07cde8/data' : 'community.wave.seqera.io/library/bcftools_htslib:0a3fa2654b52006f'}"
    ...
    def extension = args.contains("--output-type b") || args.contains("-Ob") ? "bcf.gz" :
                    ...
                    args.contains("--output-type v") || args.contains("-Ov") ? "vcf"    : "vcf.gz"
