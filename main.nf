...
workflow GENOMICMEDICINESWEDEN_NALLO {
    ...
    NALLO(
        ...
        val_skip_chromograph,
        val_skip_genome_assembly,
        (val_skip_methylation_calling || !val_methylation_callers.tokenize(',').collect { it.trim().toLowerCase() }.contains('methbat')),
        val_skip_methylation_annotation,
        (val_skip_methylation_calling || !val_methylation_callers.tokenize(',').collect { it.trim().toLowerCase() }.contains('modkit')),
        val_skip_peddy,
        val_skip_phasing,
        val_skip_prepare_gens_input,
        val_skip_qc,
