...
| `extra_vep_options_snv`              | **Optional**: Additional flags appended to the VEP command for SNV annotation (e.g. `'--plugin CADD,snv.tsv.gz --plugin SpliceAI,snv=spliceai_scores.vcf.gz'`). Plugin files must be included in `vep_plugin_files`.                                                                                                                                                          |
