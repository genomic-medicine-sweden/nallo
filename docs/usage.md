...
| `extra_vep_options_snv`              | **Optional**: Additional flags appended to the VEP command for SNV annotation, applied to both nuclear and mitochondrial SNVs (e.g. `'--plugin CADD,snv.tsv.gz --plugin SpliceAI,snv=spliceai_scores.vcf.gz'`). Plugin files must be included in `vep_plugin_files`.                                                                                                          |
...
| `extra_vep_options_sv`           | **Optional**: Additional flags appended to the VEP command for SV annotation (e.g. `'--plugin CADD,sv.tsv.gz'`). Plugin files must be included in `vep_plugin_files`.                                                                                                                                                                              |
