...
| `paraphase/{family}/{family}_paraphase_merged.vcf.gz`                   | VCF file from paraphase, merged by family                 |
| `paraphase/{family}/{family}_paraphase_merged.vcf.gz.tbi`               | Index of the VCF file merged by family                    |
| `paraphase/{family}/{family}_merged.json`                               | Summary of haplotypes and variant calls, merged by family |
