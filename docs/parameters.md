...
| `gens_coverage_bins` | Bed-file with bins for which to calculate coverage. This bed-file should be the same as used when preparing the panel of normals. Typically it would be 100bp bins evenly spaced across the genome. | `string` |  |  |  |
...
| `pipelines_testdata_base_path` | Base URL or local path to location of pipeline test dataset files | `string` | https://raw.githubusercontent.com/genomic-medicine-sweden/test-datasets/543ca28898e220a4b1e072248968ac248203eb72/ |  | True |
