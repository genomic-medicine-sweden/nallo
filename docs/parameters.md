...
| `methbat_regions` | A tsv file with only regions of interest (https://github.com/PacificBiosciences/MethBat/blob/main/data/cpgIslandExt.sorted.hg38.tsv), or with both regions and background cohort values (https://github.com/PacificBiosciences/MethBat/blob/main/data/meth_profile_model.tsv), made with the 'methbat build' function. | `string` |  |  |  |
...
| `pipelines_testdata_base_path` | Base URL or local path to location of pipeline test dataset files | `string` | https://raw.githubusercontent.com/genomic-medicine-sweden/test-datasets/9738b4e326524fa4a3d43a3b738d645a7fbd04b2/ |  | True |
...
| `extra_methbat_options` | Extra options to methbat. | `string` |  |  | True |
