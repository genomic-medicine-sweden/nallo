...
workflow NALLO {
    ...
    methylation_methbat_combined_biwgig = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_biwgig_combined // channel: [ val(meta), path(combined.bw) ]
    methylation_methbat_hap1_biwgig = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_biwgig_hap1     // channel: [ val(meta), path(hap1.bw) ]
    methylation_methbat_hap2_biwgig = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_biwgig_hap2     // channel: [ val(meta), path(hap2.bw) ]
    ...
    methylation_methbat_hap1_bed = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_bed_hap1 // channel: [ val(meta), path(bed.gz) ]
    methylation_methbat_hap1_index = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_index_hap1 // channel: [ val(meta), path(bed.gz.tbi) ]
    methylation_methbat_hap2_bed = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_bed_hap2 // channel: [ val(meta), path(bed.gz) ]
    methylation_methbat_hap2_index = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_index_hap2 // channel: [ val(meta), path(bed.gz.tbi) ]
