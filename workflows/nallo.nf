...
workflow NALLO {
    ...
    methylation_methbat_combined_bed_index = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_combined_bed_index // channel: [ val(meta), path(bed.gz.tbi) ]
    ...
    methylation_methbat_hap1_bed_index = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_hap1_bed_index // channel: [ val(meta), path(bed.gz.tbi) ]
    ...
    methylation_methbat_hap2_bed_index = (val_skip_methylation_calling || !val_run_methbat) ? channel.empty() : CALL_METHYLATION_METHBAT.out.pbcpg_hap2_bed_index // channel: [ val(meta), path(bed.gz.tbi) ]
