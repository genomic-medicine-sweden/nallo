...
workflow NALLO {
    ...
    paralogs_sample_bam = (val_skip_call_paralogs || cram_output) ? channel.empty() : CALL_PARALOGS.out.bam // channel: [ val(meta), path(bam) ]
    paralogs_sample_bai = (val_skip_call_paralogs || cram_output) ? channel.empty() : CALL_PARALOGS.out.bai // channel: [ val(meta), path(bai) ]
    paralogs_sample_cram = (val_skip_call_paralogs || !cram_output) ? channel.empty() : CALL_PARALOGS.out.cram // channel: [ val(meta), path(cram) ]
    paralogs_sample_crai = (val_skip_call_paralogs || !cram_output) ? channel.empty() : CALL_PARALOGS.out.crai // channel: [ val(meta), path(crai) ]
